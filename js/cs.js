...
screenshotButton.style.font = 'Roboto, medium, sans-serif';
screenshotButton.style.fontWeight = 'bold';
screenshotButton.innerHTML = chrome.i18n.getMessage('title');
screenshotButton.style.backgroundColor = '#ff0000';
screenshotButton.style.borderRadius = '2px';
screenshotButton.style.padding = '1px';
